...
public class SmoothFollowWoodle : MonoBehaviour
{
    public Transform woodle;    // The target we are following
    ...
    public void FixedUpdate()
    {
        ...
        Vector3 targetPosition = woodle.position + woodle.up * height - woodle.forward * distance;
        // The desired rotation
        Quaternion targetRotation = Quaternion.LookRotation(woodle.position - transform.position, woodle.up);
        #endregion
