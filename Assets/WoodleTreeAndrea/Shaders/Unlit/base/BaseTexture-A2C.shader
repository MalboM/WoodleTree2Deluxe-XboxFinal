Shader "WoodleTree/Unlit/Base/base_texture (Vertex Opt with A2C)"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag (Varys i, fixed facing : VFACE) : SV_Target
            {
                ...
                return fixed4(col.rgb, _TintColor.a);
            }
            ENDCG
        }
    }
