Shader "WoodleTree/Unlit/Triplanar/Detail/triplanar_projection_detail"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			fixed4 frag (v2f i) : SV_Target
			{
				...
				fixed4 col = (lerp(float4(1.0, 1.0, 1.0, 1.0), detailCol, _AttenuationF) * (lerp(mainCol, lerp(_RimColor, mainCol, i.uv.w), _RimIntensityF)));
