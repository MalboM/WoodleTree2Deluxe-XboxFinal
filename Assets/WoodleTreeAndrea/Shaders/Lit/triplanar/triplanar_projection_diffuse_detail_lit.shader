Shader "WoodleTree/Lit/Triplanar/Detail/triplanar_projection_diffuse_detail"
{
	Properties
	{
	...
	SubShader
	{
		...
		v2f vert(appdata v)
		{
			...
			o.direction = float4(normalize(abs(power_normal * power_normal * power_normal * power_normal)), //to avoid texture bleeding from on edge to the other
