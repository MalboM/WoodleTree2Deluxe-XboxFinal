Shader "Polymole/Effects/Dissolve/TextureGlowingDissolveV2"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag (Varys i) : SV_Target
            {
                ...
                float visibleThresh = dissolve - pow(_DissolveAmount,2.0);
                clip(visibleThresh);
                ...
                color = lerp(color,border + glow,_DissolveAmount);
            #endif
