Shader "Polymole/Effects/Dissolve/Base Color Dissolve DoubleSide (vertex)"
{
    Properties
    {
        [Header(General Settings)]
        _FrontTintColor("Front Tint Color", Color) = (0.5, 0.5, 0.5, 1.0)
        _BackTintColor("Back Tint Color", Color) = (0.5, 0.5, 0.5, 1.0)
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            // general settings
            uniform fixed3 _FrontTintColor;
            uniform fixed3 _BackTintColor;
            ...
            Varys vert (VertexAttrib v)
            {
                ...
                o.color = _BackTintColor.rgb * unity_ColorSpaceDouble;
            #ifdef RIM
            ...
            fixed4 frag (Varys i) : SV_Target
            {
                ...
                float dissolve = tex2D(_DissolveTex, i.uvMain.xy).r*0.999;
        ...
        Pass
        {
            ...
            Varys vert (VertexAttrib v)
            {
                ...
                o.color = _FrontTintColor.rgb * unity_ColorSpaceDouble;
            #ifdef RIM
                o.color = lerp(o.color, _RimColor.rgb, (1. - saturate(dot(normalize(ObjSpaceViewDir(v.OSPos)), v.OSNormal) * _RimSharpnessF)) * _RimIntensityF);
            #endif
            ...
            {
                // sample the texture [0 -> first to dissolve, 1 -> last]
                float dissolve = tex2D(_DissolveTex, i.uvMain).r * 0.999;
