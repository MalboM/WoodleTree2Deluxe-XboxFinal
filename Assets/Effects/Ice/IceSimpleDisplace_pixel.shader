Shader "Polymole/Ice/IceSimpleDisplace (Pixel)"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            {                
                ...
                #ifdef RIM
                float rimF = clamp(dot(normalize(ObjSpaceViewDir(i.objPos)), i.objNormal) * _RimSharpnessF, 0.0, 1.0);
                color = lerp(color, _RimColor, (1. - rimF)*_RimIntensityF);
                #endif
