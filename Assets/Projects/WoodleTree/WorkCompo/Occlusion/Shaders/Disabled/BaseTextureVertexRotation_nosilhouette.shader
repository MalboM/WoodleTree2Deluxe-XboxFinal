// Vertex Rotation no Silhoutte
// ref: WoodleTree/Base/BaseTextureVertexRotation (Vertex Opt)
Shader "WoodleTree/Unlit/Silhouette/Disabled/BaseTexture VertexRotation"
{
    Properties
    {
