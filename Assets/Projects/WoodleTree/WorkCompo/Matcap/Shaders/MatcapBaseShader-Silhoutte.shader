Shader "Polymole/Effects/Matcap/MatcapOcclusionBaseSilhouetteShader"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            uniform float2 _StretchDirection;
            ...
            #ifdef _EFFECT_MUL
                finalCol = matCapCol.rgb * baseCol;
            #elif _EFFECT_ADD
